...
COMMANDS: list[CommandSpec] = [
	...
	CommandSpec(
		...
		module='make_wucur_test_account',
	...
	CommandSpec(
		...
		module='register_one_account_to_db',
	...
	CommandSpec(
		...
		module='query_wucur_accounts_db',
...
def run_command(command_name: str, args: list[str]) -> int:
	...
	try:
		...
		module = import_module(f'scripts.{spec.module}')
