...
class SqliteCheckinDueRepository(AccountRepository):
...
class CloudflareKvAccountRepository(AccountRepository):
	...
	def __enter__(self) -> 'CloudflareKvAccountRepository':
		return self
...
def build_backend_repository(
	...
	*,
	...
	if name == 'worker':
		...
		return CloudflareKvAccountRepository(worker_url, worker_token, client=client)
